...
HD_PWD='C:/Users/kahak/Lab 2/Lab 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log svga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source svga.tcl -notrace
